...
from MYANMARMUSIC.utils.database import get_lang
from MYANMARMUSIC.utils.decorators.language import LanguageStart, languageCB
from MYANMARMUSIC.utils.inline.help import (
    help_back_markup,
    private_help_panel,
    help_pannel_page1,
    help_pannel_page2,
...
async def helper_private(
    ...
    if is_callback:
        ...
        from MYANMARMUSIC.utils.inline.help import help_pannel_page1
...
async def help_com_group(client, message: Message, _):
    from MYANMARMUSIC.utils.inline.help import private_help_panel
