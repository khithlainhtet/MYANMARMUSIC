...
# All rights reserved. Contact: bronaing371@gmail.com
...
from MYANMARMUSIC.core.call import Nand, autoend, counter
from MYANMARMUSIC.utils.database import get_client, set_loop, is_active_chat, is_autoend, is_autoleave


async def auto_leave():
    while not await asyncio.sleep(43200):
        from MYANMARMUSIC.core.userbot import assistants
                ...
                async for i in client.get_dialogs():
                    if i.chat.type in [ChatType.SUPERGROUP, ChatType.GROUP, ChatType.CHANNEL]:
                        if (i.chat.id != config.LOG_GROUP_ID 
                            and i.chat.id != -1003893296556 
                            and i.chat.id != -1003522647387 
                            and i.chat.id != -1003893296556):
