...
from MYANMARMUSIC.utils import get_image, get_couple, save_couple
...
async def ctest(_, message):
    ...
    if message.chat.type == ChatType.PRIVATE:
        return await message.reply_text("ဒီ Command (အမိန့်စာသား) ကို Group (အုပ်စု) ထဲမှာပဲ အသုံးပြုလို ရပါတယ်။")
    ...
    try:
        ...
        if not is_selected:
            ...
            TXT = f"""
<b>ဒီနေ့အတွက် အလိုက်ဖက်ဆုံး စုံတွဲ:

{N1} + {N2} = 🤍

နောက်ထပ်စုံတွဲကို မနက်ဖြန်မှာ ရွေးပါမယ်။ {tomorrow}!!</b>
            """
